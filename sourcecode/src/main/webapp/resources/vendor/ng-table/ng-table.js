...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<nav class="center"> <div class="ng-cloak ng-table-pager" ng-if="params.data.length"> <div ng-if="params.settings().counts.length" class="ng-table-counts btn-group pull-right"> <button ng-repeat="count in params.settings().counts" type="button" ng-class="{\'active\':params.count()==count}" ng-click="params.count(count)" class="btn btn-default"> <span ng-bind="count"></span> </button> </div> <ul ng-if="pages.length" class="pagination pagination-sm ng-table-pagination"> <li ng-class="{\'disabled\': !page.active && !page.current, \'active\': page.current}" class="page-item" ng-repeat="page in pages" ng-switch="page.type"> <a ng-switch-when="prev" class="page-link" ng-click="params.page(page.number)" href="">&laquo;</a> <a ng-switch-when="first" class="page-link" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="page" class="page-link" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="more" class="page-link" ng-click="params.page(page.number)" href="">&#8230;</a> <a ng-switch-when="last" class="page-link" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="next" class="page-link" ng-click="params.page(page.number)" href="">&raquo;</a> </li> </ul> </div> </nav>');
